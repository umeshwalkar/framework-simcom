...
#if defined(__SIMCOM_PROJ_SIM800F__) || defined(__SIMCOM_PROJ_SIM800A__)
	eat_pin_set_mode(EAT_PIN50_KBC1, EAT_PIN_MODE_KEY);
	eat_pin_set_mode(EAT_PIN49_KBC2, EAT_PIN_MODE_KEY);
	eat_pin_set_mode(EAT_PIN48_KBC3, EAT_PIN_MODE_KEY);
	eat_pin_set_mode(EAT_PIN47_KBC4, EAT_PIN_MODE_KEY);
	eat_pin_set_mode(EAT_PIN44_KBR0, EAT_PIN_MODE_KEY);
	eat_pin_set_mode(EAT_PIN43_KBR1, EAT_PIN_MODE_KEY);
	eat_pin_set_mode(EAT_PIN42_KBR2, EAT_PIN_MODE_KEY);
	eat_pin_set_mode(EAT_PIN41_KBR3, EAT_PIN_MODE_KEY);
	eat_pin_set_mode(EAT_PIN40_KBR4, EAT_PIN_MODE_KEY);
