 ...
 * Macros
 ********************************************************************/
#if defined(__SIMCOM_PROJ_SIM800C__)
    #define EAT_PIN_INT0 EAT_PIN4_UART1_CTS
    #define EAT_PIN_INT1 EAT_PIN6_UART1_DTR
    #define EAT_PIN_INT2 EAT_PIN14_SIM_DET
#elif defined(__SIMCOM_PROJ_SIM808__)
    #define EAT_PIN_INT0 EAT_PIN9_DTR
    #define EAT_PIN_INT1 EAT_PIN33_SIM_PRE
    #define EAT_PIN_INT2 EAT_PIN41_PWM2
#elif defined(__SIMCOM_PROJ_SIM800F__) || defined(__SIMCOM_PROJ_SIM800A__)
    #define EAT_PIN_INT0 EAT_PIN3_DTR
    #define EAT_PIN_INT1 EAT_PIN4_RI
    #define EAT_PIN_INT2 EAT_PIN5_DCD
#elif defined(__SIMCOM_PROJ_SIM808__)
    #define EAT_PIN_INT0 EAT_PIN9_DTR
    #define EAT_PIN_INT1 EAT_PIN33_SIM_PRE
    #define EAT_PIN_INT2 EAT_PIN41_PWM2
#elif defined(__SIMCOM_PROJ_SIM868__)
    #define EAT_PIN_INT0 EAT_PIN4_UART1_CTS
    #define EAT_PIN_INT1 EAT_PIN6_UART1_DTR
    #define EAT_PIN_INT2 EAT_PIN14_SIM1_DET    
    #define EAT_PIN_INT3 EAT_PIN52_SIM2_DET       
#endif
/********************************************************************
* Types
 ********************************************************************/
...
void app_func_ext1(void *data)
{
	...
	*/
    ...
    //eat_sim_detect_en(EAT_FALSE); //disable SIM card detection and will use it as eint

    eat_pin_set_mode(EAT_PIN_INT0, EAT_PIN_MODE_EINT);
    eat_pin_set_mode(EAT_PIN_INT1, EAT_PIN_MODE_EINT); 
    eat_pin_set_mode(EAT_PIN_INT2, EAT_PIN_MODE_EINT);
    eat_pin_set_mode(EAT_PIN_INT3, EAT_PIN_MODE_EINT);
...
eat_bool eat_module_test_eint(u8 param1, u8 param2)
{
    ...
    if( 1 == param1 )
    {
        if( 1 == param2 )
        {
           eat_int_setup(EAT_PIN_INT0, EAT_INT_TRIGGER_HIGH_LEVEL, 10, test_handler_int_level);
           eat_trace("EINT test 1,1 start");
           eat_trace("System will interrupt  TRIGGER_HIGH_LEVEL");
        }else if( 2 == param2)
        {                   
            eat_int_setup(EAT_PIN_INT0, EAT_INT_TRIGGER_FALLING_EDGE, 10, test_handler_int_edge);
            eat_int_setup(EAT_PIN_INT1, EAT_INT_TRIGGER_FALLING_EDGE, 10, test_handler_int_edge);
            eat_int_setup(EAT_PIN_INT2, EAT_INT_TRIGGER_FALLING_EDGE, 10, test_handler_int_edge);
            eat_int_setup(EAT_PIN_INT3, EAT_INT_TRIGGER_FALLING_EDGE, 10, test_handler_int_edge);
    ...
    /***************************************
     * example 2
     * interrupt used EVENT
     ***************************************/
    else if( 2 == param1 )
    {
        if( 1 == param2)
        {
           eat_gpio_setup(EAT_PIN_INT0, EAT_GPIO_DIR_INPUT, EAT_GPIO_LEVEL_LOW);
           if( EAT_GPIO_LEVEL_LOW == eat_gpio_read(EAT_PIN_INT0)) 
           {   
               eat_trace("EINT PIN%d HIGH LEVEL int test start", EAT_PIN_INT0);
               eat_int_setup(EAT_PIN_INT0, EAT_INT_TRIGGER_HIGH_LEVEL, 10, NULL);
           }
           else
           {
               eat_trace("EINT PIN%d LOW LEVEL int test start", EAT_PIN_INT0);
               eat_int_setup(EAT_PIN_INT0, EAT_INT_TRIGGER_LOW_LEVEL, 10, NULL);
           }
           
           eat_gpio_setup(EAT_PIN_INT1, EAT_GPIO_DIR_INPUT, EAT_GPIO_LEVEL_LOW);
           if( EAT_GPIO_LEVEL_LOW == eat_gpio_read(EAT_PIN_INT1)) 
           {
               eat_trace("EINT PIN%d HIGH LEVEL int test start", EAT_PIN_INT1);
               eat_int_setup(EAT_PIN_INT1, EAT_INT_TRIGGER_HIGH_LEVEL, 10, NULL);
           }else
           {
               eat_trace("EINT PIN%d LOW LEVEL int test start", EAT_PIN_INT1);
               eat_int_setup(EAT_PIN_INT1, EAT_INT_TRIGGER_LOW_LEVEL, 10, NULL);
           }
           
           eat_gpio_setup(EAT_PIN_INT2, EAT_GPIO_DIR_INPUT, EAT_GPIO_LEVEL_LOW);
           if( EAT_GPIO_LEVEL_LOW == eat_gpio_read(EAT_PIN_INT2)) 
           {
               eat_trace("EINT PIN%d HIGH LEVEL int test start", EAT_PIN_INT2);
               eat_int_setup(EAT_PIN_INT2, EAT_INT_TRIGGER_HIGH_LEVEL, 10, NULL);
           }else
           {
               eat_trace("EINT PIN%d LOW LEVEL int test start", EAT_PIN_INT2);
               eat_int_setup(EAT_PIN_INT2, EAT_INT_TRIGGER_LOW_LEVEL, 10, NULL);
           }
        ...
        {
           eat_int_setup(EAT_PIN_INT0, EAT_INT_TRIGGER_RISING_EDGE, 10, NULL);
