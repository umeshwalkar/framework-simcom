...
/*****************************************************************************
 * Function :eat_fs_Abort
 * Description: This function can abort the action on specified file handle right away.
 * Parameters :
 * 	ActionHandle : [IN]  The action on the specified file handle will be aborted.
 ...
 *                              (3) FS_ABORT_XDELETE (0x87654321): Special file handle to abort eat_fs_XDelete
 * Returns:
 *  	Successful  : EAT_FS_NO_ERROR
 *  	Failed      : Please refer to eat_fs_error_enum.
 * NOTE
 *     Nothing 
 *****************************************************************************/
extern int (* const  eat_fs_Abort)(UINT ActionHandle);
